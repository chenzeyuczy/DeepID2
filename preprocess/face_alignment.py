...
if __name__ == "__main__":
	src_dataset = "/home/chenzeyu/dataset/lfw-deepfunneled/"
	des_dataset = "/home/chenzeyu/dataset/lfw-cropped/"
...
#			(x, y, w, h) = face
#			assert w == h
#			if not min_w or min_w > w:
#				min_w = w
#			if not max_w or max_w < w:
#				max_w = w
#			if not min_h or min_h > h:
#				min_h = h
#			if not max_h or max_h < h:
#				max_h = h
#
